          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-fade-up">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Link href="/en/how-it-works" className="inline-flex items-center gap-2 px-6 py-3 rounded-md bg-secondary text-foreground text-sm font-semibold hover:bg-border transition-colors">
                  {t("blog.ctaSecondary")}
                </Link>
              </div>
            </div>
